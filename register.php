...
<form method="post" action="save.php">
    ...
    <label for="regstu_pass">Password:</label>
        ...
        <input type="password" id="reg_password" name="regstu_pass">
  ...
  <label for="regstu_email">Email address:</label>
        <input type="text" id="reg_email" name="regstu_email">
  <br></br>
...
<form method="post" action="save.php">
  ...
  <br></br>
    <label for="regemp_pass">Password:</label>
        <input type="password" id="reg_password" name="regemp_pass">
      <span>Enter a password longer than 8 characters</span>
  ...
  <label for="regemp_email">Email address:</label>
        <input type="text" id="reg_email" name="regemp_email">
  <br></br>
